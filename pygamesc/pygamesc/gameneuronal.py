...
def mostrar_menu():
    ...
    pantalla.fill(NEGRO)
    texto = fuente.render("Presiona 'A' para Auto, 'M' para Manual,'E' para entrenar, o 'Q' para Salir", True, BLANCO)
...
def generar_arbol(datos_modelo):
    ...
    print("Árbol de decisión entrenado y guardado en 'modelo_entrenado_arbol'.")
